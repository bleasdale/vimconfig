...
"  call Decho("sourcing rainbow.vvim")
   if &ft == "c" || &ft == "c++"
	...
	exe "runtime syntax/c/rainbow.vvim"

   elseif &ft == "matlab"
    augroup AugroupRainbow
 	 au BufNewFile,BufReadPost *.m	Rainbow
 	augroup END
	runtime syntax/matlab/rainbow.vvim

   elseif &ft == "javascript"
    augroup AugroupRainbow
 	 au BufNewFile,BufReadPost *.js	Rainbow
 	augroup END
	runtime syntax/javascript/rainbow.vvim

   elseif &ft == "tex"
    augroup AugroupRainbow
 	 au BufNewFile,BufReadPost *.tex	Rainbow
 	augroup END
	runtime syntax/tex/rainbow.vvim
   ...
   elseif &ft == "lisp"
	...
	set ft=lisp
	runtime syntax/lisp/rainbow.vvim

   elseif &ft == "vim"
    augroup AugroupRainbow
	 au BufNewFile,BufReadPost *.vim	Rainbow
 	augroup END
	runtime syntax/vim/rainbow.vvim
   endif
...
" ---------------------------------------------------------------------
" Rainbow#SplitRainbow: {{{2
fun! Rainbow#SplitRainbow(hlrainbow)
"  call Dfunc("Rainbow#SplitRainbow(hlrainbow=".a:hlrainbow.")")
  keepalt noswapfile bel wincmd v
  ownsyntax
  setl scb
  norm! zR
  wincmd h
  ...
  norm! zR
  wincmd l
  call Rainbow#Rainbow(1,a:hlrainbow)

"  call Dret("Rainbow#SplitRainbow")
endfun
...
let &cpo= keepcpo
" vim: fdm=marker ft=vim ts=4
after/syntax/vim/rainbow.vvim	[[[1
267
